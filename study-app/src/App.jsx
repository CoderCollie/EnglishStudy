...
function App() {
  ...
  return (
    <div className="flex h-screen w-screen bg-slate-950 text-slate-100 overflow-hidden font-noto flex-col fixed inset-0 overscroll-none select-none">
      ...
      {/* Stats Dashboard Overlay (노치 위치 고려) */}
      {showStats && (
        <div 
          className="absolute right-4 md:right-8 z-[100] w-64 bg-slate-900 border border-slate-700 rounded-3xl shadow-2xl p-6 backdrop-blur-xl animate-in fade-in zoom-in duration-200"
          style={{ top: 'calc(var(--safe-top) + 80px)' }}
        >
          ...
          <button 
            ...
            className="w-full mt-6 py-2 rounded-xl bg-slate-800 text-[10px] font-bold text-slate-400 uppercase tracking-widest"
          >
            Close
          </button>
        </div>
      ...
      {/* Main Area with Bottom Safe Area Padding */}
      <div className="flex-1 flex flex-col relative overflow-hidden bg-[radial-gradient(circle_at_50%_0%,_var(--tw-gradient-stops))] from-slate-900 via-slate-950 to-black p-4">
        <div className="flex-1 flex flex-col items-center justify-center">
          ...
          {/* Flashcard */}
          <div 
            className="w-full max-w-lg aspect-[4/5] perspective-1000 cursor-pointer max-h-[500px]"
              ...
              <div className="absolute w-full h-full backface-hidden rotate-y-180 bg-white text-slate-900 rounded-[2.5rem] shadow-2xl flex flex-col overflow-hidden">
                <div className="flex-1 overflow-y-auto custom-scrollbar p-6 md:p-10 text-left">
                  ...
                  <div className="space-y-5">
                    ...
                    <div>
                      <p className="text-orange-500 text-[9px] font-black uppercase mb-1 tracking-widest italic leading-none">Vocabulary & Nuance</p>
                ...
                <div className="p-4 bg-slate-50 border-t border-slate-100 flex gap-2 flex-shrink-0">
                  <button onClick={(e) => { e.stopPropagation(); nextCard(); }} className="flex-1 py-4 rounded-2xl bg-slate-200 text-slate-600 text-xs font-black uppercase tracking-widest active:scale-95 transition-all">Again</button>
          ...
          {/* Bottom Nav Area with Safe Area Bottom */}
          <div 
            className="mt-8 w-full max-w-sm flex items-center justify-between gap-4 flex-shrink-0"
          ...
          >
            ...
            <button onClick={shuffleDeck} className="flex-1 flex items-center justify-center gap-3 py-4 rounded-2xl bg-slate-900 border border-slate-800 text-blue-400 active:scale-95 shadow-xl group">
              ...
              <span className="text-xs font-black uppercase tracking-[0.2em]">Shuffle</span>
            </button>
